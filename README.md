...
2. **Instalar Dependencias:** Haz doble clic en el archivo `INSTALAR_DEPENDENCIAS.bat`. Esto instalará todo lo necesario automáticamente.
...
- `downloader.py`: Gestor de descargas aceleradas.
